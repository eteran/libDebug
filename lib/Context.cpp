...
RegisterRef Context::get_64(RegisterId reg) {
	...
	// SIMD Registers
	case RegisterId::XMM0:		return make_register("xmm0",  xstate_.xmm.registers[0].data,  16, 0);
	case RegisterId::XMM1:		return make_register("xmm1",  xstate_.xmm.registers[1].data,  16, 0);
	case RegisterId::XMM2:		return make_register("xmm2",  xstate_.xmm.registers[2].data,  16, 0);
	case RegisterId::XMM3:		return make_register("xmm3",  xstate_.xmm.registers[3].data,  16, 0);
	case RegisterId::XMM4:		return make_register("xmm4",  xstate_.xmm.registers[4].data,  16, 0);
	case RegisterId::XMM5:		return make_register("xmm5",  xstate_.xmm.registers[5].data,  16, 0);
	case RegisterId::XMM6:		return make_register("xmm6",  xstate_.xmm.registers[6].data,  16, 0);
	case RegisterId::XMM7:		return make_register("xmm7",  xstate_.xmm.registers[7].data,  16, 0);
	case RegisterId::XMM8:		return make_register("xmm8",  xstate_.xmm.registers[8].data,  16, 0);
	case RegisterId::XMM9:		return make_register("xmm9",  xstate_.xmm.registers[9].data,  16, 0);
	case RegisterId::XMM10:		return make_register("xmm10", xstate_.xmm.registers[10].data, 16, 0);
	case RegisterId::XMM11:		return make_register("xmm11", xstate_.xmm.registers[11].data, 16, 0);
	case RegisterId::XMM12:		return make_register("xmm12", xstate_.xmm.registers[12].data, 16, 0);
	case RegisterId::XMM13:		return make_register("xmm13", xstate_.xmm.registers[13].data, 16, 0);
	case RegisterId::XMM14:		return make_register("xmm14", xstate_.xmm.registers[14].data, 16, 0);
	case RegisterId::XMM15:		return make_register("xmm15", xstate_.xmm.registers[15].data, 16, 0);

	case RegisterId::YMM0:		return make_register("ymm0",  xstate_.xmm.registers[0].data,  32, 0);
	case RegisterId::YMM1:		return make_register("ymm1",  xstate_.xmm.registers[1].data,  32, 0);
	case RegisterId::YMM2:		return make_register("ymm2",  xstate_.xmm.registers[2].data,  32, 0);
	case RegisterId::YMM3:		return make_register("ymm3",  xstate_.xmm.registers[3].data,  32, 0);
	case RegisterId::YMM4:		return make_register("ymm4",  xstate_.xmm.registers[4].data,  32, 0);
	case RegisterId::YMM5:		return make_register("ymm5",  xstate_.xmm.registers[5].data,  32, 0);
	case RegisterId::YMM6:		return make_register("ymm6",  xstate_.xmm.registers[6].data,  32, 0);
	case RegisterId::YMM7:		return make_register("ymm7",  xstate_.xmm.registers[7].data,  32, 0);
	case RegisterId::YMM8:		return make_register("ymm8",  xstate_.xmm.registers[8].data,  32, 0);
	case RegisterId::YMM9:		return make_register("ymm9",  xstate_.xmm.registers[9].data,  32, 0);
	case RegisterId::YMM10:		return make_register("ymm10", xstate_.xmm.registers[10].data, 32, 0);
	case RegisterId::YMM11:		return make_register("ymm11", xstate_.xmm.registers[11].data, 32, 0);
	case RegisterId::YMM12:		return make_register("ymm12", xstate_.xmm.registers[12].data, 32, 0);
	case RegisterId::YMM13:		return make_register("ymm13", xstate_.xmm.registers[13].data, 32, 0);
	case RegisterId::YMM14:		return make_register("ymm14", xstate_.xmm.registers[14].data, 32, 0);
	case RegisterId::YMM15:		return make_register("ymm15", xstate_.xmm.registers[15].data, 32, 0);

	case RegisterId::ZMM0:		return make_register("zmm0",  xstate_.xmm.registers[0].data,  64, 0);
	case RegisterId::ZMM1:		return make_register("zmm1",  xstate_.xmm.registers[1].data,  64, 0);
	case RegisterId::ZMM2:		return make_register("zmm2",  xstate_.xmm.registers[2].data,  64, 0);
	case RegisterId::ZMM3:		return make_register("zmm3",  xstate_.xmm.registers[3].data,  64, 0);
	case RegisterId::ZMM4:		return make_register("zmm4",  xstate_.xmm.registers[4].data,  64, 0);
	case RegisterId::ZMM5:		return make_register("zmm5",  xstate_.xmm.registers[5].data,  64, 0);
	case RegisterId::ZMM6:		return make_register("zmm6",  xstate_.xmm.registers[6].data,  64, 0);
	case RegisterId::ZMM7:		return make_register("zmm7",  xstate_.xmm.registers[7].data,  64, 0);
	case RegisterId::ZMM8:		return make_register("zmm8",  xstate_.xmm.registers[8].data,  64, 0);
	case RegisterId::ZMM9:		return make_register("zmm9",  xstate_.xmm.registers[9].data,  64, 0);
	case RegisterId::ZMM10:		return make_register("zmm10", xstate_.xmm.registers[10].data, 64, 0);
	case RegisterId::ZMM11:		return make_register("zmm11", xstate_.xmm.registers[11].data, 64, 0);
	case RegisterId::ZMM12:		return make_register("zmm12", xstate_.xmm.registers[12].data, 64, 0);
	case RegisterId::ZMM13:		return make_register("zmm13", xstate_.xmm.registers[13].data, 64, 0);
	case RegisterId::ZMM14:		return make_register("zmm14", xstate_.xmm.registers[14].data, 64, 0);
	case RegisterId::ZMM15:		return make_register("zmm15", xstate_.xmm.registers[15].data, 64, 0);
