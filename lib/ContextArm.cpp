...
RegisterRef Context::get_64(RegisterId reg) const {
	...
	case RegisterId::FPSR:		return make_register("fpsr", vfp_regs_.fpsr, 0);
	case RegisterId::FPCR:		return make_register("fpcr", vfp_regs_.fpcr, 0);
	case RegisterId::V0:		return make_register("v0", vfp_regs_.vregs[0], 0);
	case RegisterId::V1:		return make_register("v1", vfp_regs_.vregs[1], 0);
	case RegisterId::V2:		return make_register("v2", vfp_regs_.vregs[2], 0);
	case RegisterId::V3:		return make_register("v3", vfp_regs_.vregs[3], 0);
	case RegisterId::V4:		return make_register("v4", vfp_regs_.vregs[4], 0);
	case RegisterId::V5:		return make_register("v5", vfp_regs_.vregs[5], 0);
	case RegisterId::V6:		return make_register("v6", vfp_regs_.vregs[6], 0);
	case RegisterId::V7:		return make_register("v7", vfp_regs_.vregs[7], 0);
	case RegisterId::V8:		return make_register("v8", vfp_regs_.vregs[8], 0);
	case RegisterId::V9:		return make_register("v9", vfp_regs_.vregs[9], 0);
	case RegisterId::V10:		return make_register("v10", vfp_regs_.vregs[10], 0);
	case RegisterId::V11:		return make_register("v11", vfp_regs_.vregs[11], 0);
	case RegisterId::V12:		return make_register("v12", vfp_regs_.vregs[12], 0);
	case RegisterId::V13:		return make_register("v13", vfp_regs_.vregs[13], 0);
	case RegisterId::V14:		return make_register("v14", vfp_regs_.vregs[14], 0);
	case RegisterId::V15:		return make_register("v15", vfp_regs_.vregs[15], 0);
	case RegisterId::V16:		return make_register("v16", vfp_regs_.vregs[16], 0);
	case RegisterId::V17:		return make_register("v17", vfp_regs_.vregs[17], 0);
	case RegisterId::V18:		return make_register("v18", vfp_regs_.vregs[18], 0);
	case RegisterId::V19:		return make_register("v19", vfp_regs_.vregs[19], 0);
	case RegisterId::V20:		return make_register("v20", vfp_regs_.vregs[20], 0);
	case RegisterId::V21:		return make_register("v21", vfp_regs_.vregs[21], 0);
	case RegisterId::V22:		return make_register("v22", vfp_regs_.vregs[22], 0);
	case RegisterId::V23:		return make_register("v23", vfp_regs_.vregs[23], 0);
	case RegisterId::V24:		return make_register("v24", vfp_regs_.vregs[24], 0);
	case RegisterId::V25:		return make_register("v25", vfp_regs_.vregs[25], 0);
	case RegisterId::V26:		return make_register("v26", vfp_regs_.vregs[26], 0);
	case RegisterId::V27:		return make_register("v27", vfp_regs_.vregs[27], 0);
	case RegisterId::V28:		return make_register("v28", vfp_regs_.vregs[28], 0);
	case RegisterId::V29:		return make_register("v29", vfp_regs_.vregs[29], 0);
	case RegisterId::V30:		return make_register("v30", vfp_regs_.vregs[30], 0);
	case RegisterId::V31:		return make_register("v31", vfp_regs_.vregs[31], 0);
